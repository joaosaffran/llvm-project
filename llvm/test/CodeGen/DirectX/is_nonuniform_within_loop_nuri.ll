...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  %nuri = tail call noundef i32 @llvm.dx.resource.nonuniformindex(i32 %phi)
  %binding = tail call target("dx.RawBuffer", i32, 1, 0) @llvm.dx.resource.handlefrombinding(i32 0, i32 0, i32 4, i32 %nuri, ptr nonnull @Out.str)
