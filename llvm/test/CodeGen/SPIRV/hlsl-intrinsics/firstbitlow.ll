...
; [[add_result:%.+]] = OpIAdd [[u32_t]] [[ans_offset]] [[ans_bits]]
; [[is_not_found:%.+]]  = OpIEqual [[bool_t]] [[ans_bits]] [[const_neg1]]
; [[ret:%.+]] = OpSelect [[u32_t]] [[is_not_found]]  [[const_neg1]] [[add_result:]]
; OpReturnValue [[ret]]
...
; CHECK: [[add_result:%.+]] = OpIAdd [[u32x2_t]] [[ans_offset]] [[ans_bits]]
; CHECK: [[is_not_found:%.+]]  = OpIEqual [[boolx2_t]] [[ans_bits]] [[const_neg1x2]]
; CHECK: [[ret:%.+]] = OpSelect [[u32x2_t]] [[is_not_found]]  [[const_neg1x2]] [[add_result]]
; OpReturnValue [[ret]]
...
; CHECK: [[pt1_is_not_found:%.+]] = OpIEqual [[boolx2_t]] [[pt1_ans_bits]] [[const_neg1x2]]
; CHECK: [[pt1_ret:%.+]] = OpSelect [[u32x2_t]] [[pt1_is_not_found]] [[const_neg1x2]] [[pt1_res]]
...
; CHECK: [[pt2_is_not_found:%.+]] = OpIEqual [[bool_t]] [[pt2_ans_bits]] [[const_neg1]]
; CHECK: [[pt2_ret:%.+]] = OpSelect [[u32_t]] [[pt2_is_not_found]] [[const_neg1]] [[pt2_res]]
...
; CHECK: [[pt2_is_not_found:%.+]] = OpIEqual [[boolx2_t]] [[pt2_ans_bits]] [[const_neg1x2]]
; CHECK: [[pt2_ret:%.+]] = OpSelect [[u32x2_t]] [[pt2_is_not_found]] [[const_neg1x2]] [[pt2_res]]
