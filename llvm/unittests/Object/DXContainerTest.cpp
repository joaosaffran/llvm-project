...
TEST(RootSignature, ParseRootDescriptor) {
  {
    uint8_t Buffer[] = {
        0x44, 0x58, 0x42, 0x43, 0x32, 0x9a, 0x53, 0xd8, 0xec, 0xbe, 0x35, 0x6f,
        0x05, 0x39, 0xe1, 0xfe, 0x31, 0x20, 0xf0, 0xc1, 0x01, 0x00, 0x00, 0x00,
        0x84, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00,
        0x4c, 0x00, 0x00, 0x00, 0x44, 0x58, 0x49, 0x4c, 0x1c, 0x00, 0x00, 0x00,
        0x65, 0x00, 0x05, 0x00, 0x08, 0x00, 0x00, 0x00, 0x44, 0x58, 0x49, 0x4c,
        0x05, 0x01, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00,
        0x42, 0x43, 0xc0, 0xde, 0x52, 0x54, 0x53, 0x30, 0x30, 0x00, 0x00, 0x00,
  ...
  }
  {
    ...
    uint8_t Buffer[] = {
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00,
        0x02, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x24, 0x00, 0x00, 0x00,
        0x15, 0x00, 0x00, 0x00, 0x16, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00, 0x00};
    EXPECT_THAT_EXPECTED(
        DXContainer::create(getMemoryBuffer<133>(Buffer)),
        FailedWithMessage("unsupported root descriptor flag value read: 255"));
  }
  {
    // ther version was set to 1
    uint8_t Buffer[] = {
        0x44, 0x58, 0x42, 0x43, 0x32, 0x9a, 0x53, 0xd8, 0xec, 0xbe, 0x35, 0x6f,
        0x05, 0x39, 0xe1, 0xfe, 0x31, 0x20, 0xf0, 0xc1, 0x01, 0x00, 0x00, 0x00,
        0x84, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00,
    ...
    EXPECT_THAT_EXPECTED(
        DXContainer::create(getMemoryBuffer<133>(Buffer)),
        FailedWithMessage("unsupported root descriptor flag value read: 1"));
  }
  {
    // ther version was set to 1
    uint8_t Buffer[] = {
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00,
        0x02, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x24, 0x00, 0x00, 0x00,
        0x15, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xF0, 0x01, 0x00, 0x00, 0x00};
    EXPECT_THAT_EXPECTED(
        DXContainer::create(getMemoryBuffer<133>(Buffer)),
        FailedWithMessage("invalid shader space value read: 4043309055"));
  }
}
